...
import { bodyClient, bodyClientStatus, paramsClientId } from "../middlewares/validateClients";
...
router.put(`${api}/clients/:id`, paramsClientId, bodyClientStatus, controllerClient.updateClient);
